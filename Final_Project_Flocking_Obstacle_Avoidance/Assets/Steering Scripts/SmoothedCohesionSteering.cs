...
[CreateAssetMenu(menuName = "Flock/Behaviour/SmoothedCohesionSteering")]
public class SmoothedCohesionSteering : Steering
{
    ...
    public override Vector2 GetSteering(Boid boid, List<Transform> context, Flock flock)
    {
        ...
        averagePos = Vector2.SmoothDamp(boid.transform.up, averagePos, ref currentVelocity, smoothTime);
